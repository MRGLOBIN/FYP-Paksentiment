...
const SOURCES = [
  ...
  },
  {
    ...
    name: "AI Search",
    description:
      "Ask AI a question to automatically select and scrape the best URLs",
    icon: <AutoAwesome />,
    color: "#EAB308", // Amber/Gold color
    placeholder:
      "What are you looking for? (e.g. Find news about Pakistan economy)",
          ...
          <div className={styles.queryInputWrapper}>
            ...
            {source === "web" && multiUrlMode ? (
              <textarea
                ...
                value={multiUrls}
                onChange={(e) =>
                  handleInputChange(setMultiUrls, e.target.value)
                }
          ...
          <div className={styles.optionRow}>
            <div className={styles.tagsInput}>
              ...
              <input
                ...
                value={customTags}
                onChange={(e) =>
                  handleInputChange(setCustomTags, e.target.value)
                }
              />
            </div>
          </div>
