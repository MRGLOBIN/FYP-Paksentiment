...
const SOURCES = [
  ...
  {
    id: 'integrations_hackernews',
    name: 'Hacker News',
    description: 'Fetch top discussions and sentiment from YC Hacker News',
    icon: <Forum />,
    color: '#FF6600',
    placeholder: 'Enter tech topic (e.g. artificial intelligence)',
    inputLabel: 'Search Query',
  },
  {
    id: 'integrations_newsapi',
    name: 'News API',
    description: 'Search official global news outlets and publishers',
    icon: <Newspaper />,
    color: '#0ea5e9',
    placeholder: 'Enter news topic (e.g. global economy)',
    inputLabel: 'News Query',
  },
  {
    id: 'integrations_newsdata',
    name: 'NewsData.io',
    description: 'Search breaking news and historical articles',
    icon: <Public />,
    color: '#3b82f6',
    placeholder: 'Enter topic (e.g. technology advancements)',
    inputLabel: 'News Query',
  },
  {
    id: 'integrations_gdelt',
    name: 'GDELT Global Events',
    description: 'Monitor global events and sentiments across 65 languages',
    icon: <Language />,
    color: '#6366f1',
    placeholder: 'Enter global event (e.g. elections)',
    inputLabel: 'Event Query',
  },
  {
    id: 'integrations_mastodon',
    name: 'Mastodon',
    description: 'Track decentralized microblogging sentiment (Fediverse)',
    icon: <ChatBubbleOutline />,
    color: '#6364FF',
    placeholder: 'Enter topic or hashtag (e.g. #tech)',
    inputLabel: 'Search Query',
  },
  {
    id: 'integrations_stackoverflow',
    name: 'Stack Overflow',
    description: 'Gauge developer sentiment and technical Q&A',
    icon: <Code />,
    color: '#f97316',
    placeholder: 'Enter technical term (e.g. reactjs hooks)',
    inputLabel: 'Search Query',
  },
  {
    id: 'integrations_googletrends',
    name: 'Google Trends',
    description: 'Analyze global search interest over time',
    icon: <TrendingUp />,
    color: '#4285F4',
  ...
  },
  {
    id: 'integrations_rss',
    name: 'RSS Feed',
    description: 'Fetch and analyze sentiment from any custom RSS URL',
    icon: <RssFeed />,
    color: '#f59e0b',
    placeholder: 'Enter RSS feed URL (e.g. https://hnrss.org/frontpage)',
    inputLabel: 'RSS URL',
  },
  {
    id: 'ai',
